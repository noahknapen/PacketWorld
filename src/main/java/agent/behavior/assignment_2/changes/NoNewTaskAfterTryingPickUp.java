...
public class NoNewTaskAfterTryingPickUp extends BehaviorChange {
    ...
    private boolean noNewTaskAfterTryingPickUp;
    ...
    public void updateChange() {
        ...
        {
            noNewTaskAfterTryingPickUp = checkNoAlternateTaskDefinition(agentState);
        }
     ...
     */
    private boolean checkNoAlternateTaskDefinition(AgentState agentState) {
        ...
        Packet packet = MemoryUtils.getObjectFromMemory(agentState, MemoryKeys.TASK, Task.class).getPacket();

        discoveredPackets.remove(packet);
